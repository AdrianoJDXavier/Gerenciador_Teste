...
foreach($dados as $row){
    $observacao = html_entity_decode(strip_tags($row['observacao']));
    ...
    $planilha->getActiveSheet()->SetCellValue('I'.$contador, $observacao);
...
$name = "RELATORIO_TESTE_".date('d/m/Y')."xlsx";
